        ...
        <tbody>
          {data.map((item, index) => (
            <tr key={index} className="text-center">
              <td className="py-2 px-4 border-b dark:border-b-gray-600">{item.task_title}</td>
              <td className="py-2 px-4 border-b dark:border-b-gray-600">{`${daysRemaining(item.end_date)} days`}</td>
